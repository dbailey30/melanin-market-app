...
function App() {
  ...
  // Logo component with fallback - using external URL for your logo
  const LogoComponent = () => {
    const [logoError, setLogoError] = useState(false);
    
    // You can replace this URL with your uploaded logo or use the fallback
    const logoSrc = "/logo.png"; // This will look for logo.png in your public folder
    
    return logoError ? (
      <div style={styles.logoFallback}>🛍️</div>
    ) : (
      <img 
        src={logoSrc} 
